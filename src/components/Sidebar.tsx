      ...
      <div className="w-full h-full overflow-y-auto">
        ...
        <div className="mb-6 px-3">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              <svg width="120" height="32" viewBox="0 0 940 940" className="mr-2">
                <defs>
                  <style>
                    {`.st0 { fill: #fff; stroke: #000; stroke-miterlimit: 10; }`}
                  </style>
                </defs>
                <rect className="st0" width="940" height="940"/>
            ...
            <button 
              ...
              className="inline-flex items-center justify-center px-3 py-1.5 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded border border-primary-600 transition-colors"
              title="Add Task"
            >
              Add Task +
            </button>
